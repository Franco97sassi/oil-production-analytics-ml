...
DEFAULT_PUBLISHED_METRICS_PATH = PROJECT_ROOT / "docs" / "metrics" / "strict_temporal_metrics.json"
...
CATEGORICAL_FEATURES = [
    "tipoextraccion", "tipoestado", "tipopozo", "provincia", "cuenca",
]
FEATURES = NUMERIC_FEATURES + CATEGORICAL_FEATURES
REQUIRED_COLUMNS = [
    "anio", "mes", ID_COLUMN, TARGET, *OPERATIONAL_COLUMNS, *CATEGORICAL_FEATURES,
]
RANDOM_STATE = 42
